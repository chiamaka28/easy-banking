...
const Hero = () => {
  return (
    <div className="flex flex-col md:flex-row-reverse justify-between  lg:h-[65vh] ">
      <div className="bg-mobile md:bg-desktop bg-left lg:bg-[right_-3rem_top_-2rem] bg-cover   bg-no-repeat py-[70px] md:py-[50px] mr-[-7%]">
      ...
      <div className="md:w-[40%] md:py-[3rem] md:px-[2rem] lg:py-[4rem] lg:mx-[8rem] mt-4 mb-20 flex flex-col  justify-center items-center md:justify-start md:items-start">
